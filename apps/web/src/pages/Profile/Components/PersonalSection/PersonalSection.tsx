...
import PersonalSectionMobile from "./PersonalSectionMobile";
...
const PersonalSection = ({
  ...
  if (isMobile) {
    console.log("Rendering PersonalSectionMobile");
    return (
  ...
  return (
    <>
    {console.log("Rendering PersonalSection Desktop")}
        ...
        {tab === "about" && (
          <div style={{ gridColumn: "1 / -1", display: "grid", gap: 16, width: "100%" }}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div style={{ width: "100%", justifyContent: "flex-start", display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 12 }}>
                  ...
                  <div
                    style={{
                      ...
                      height: 32,
                      borderRadius: "50%",
                      background: `conic-gradient(var(--linkColor) ${Math.min(
                        100,
                        (LVL.indexOf(l.level) + 1) * (100 / LVL.length)
