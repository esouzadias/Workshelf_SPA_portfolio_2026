      ...
      <div className="container">
        <form className="card form-grid" onSubmit={onSubmit} style={{ display: "grid", gap: 12 }}>
          <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 1 }}>
            ...
            >
              <Tab className="tab" label={activeLanguage.dictionary.profile} icon={<PersonIcon />} iconPosition="start" />
              <Tab label={activeLanguage.dictionary.work} icon={<WorkIcon />} iconPosition="start" />
              <Tab label={activeLanguage.dictionary.education} icon={<BookRounded />} iconPosition="start" />
              <Tab label={activeLanguage.dictionary.personal} icon={<PersonIcon />} iconPosition="start" />
              <Tab label={activeLanguage.dictionary.account} icon={<SettingsIcon />} iconPosition="start" />
            </Tabs>
          </Box>
